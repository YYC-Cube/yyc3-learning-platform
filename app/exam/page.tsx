...
export default function ExamPage() {
  ...
  if (showResult) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4 pb-24">
        {/* 返回按钮 - 固定在左上角 */}
        <div className="fixed top-4 left-4 z-10">
          <Button variant="outline" asChild className="flex items-center gap-2 bg-white/90 backdrop-blur-sm">
            <Link href="/exam" className="inline-flex items-center justify-center gap-2">
