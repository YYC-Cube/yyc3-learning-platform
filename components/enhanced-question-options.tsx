/**
 * @fileoverview UI组件 · enhanced-question-options.tsx
...
export function EnhancedQuestionOptions({
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start space-x-2">
                  ...
                  <div
                    className={`text-sm leading-relaxed ${focusMode ? 'text-gray-200' : 'text-gray-900'}`}
                  >
                    {option}
                  </div>
                </div>
  ...
  const MultipleChoiceQuestion = () => (
    <div className="space-y-3">
      ...
      {/* 多选题提示 */}
      <div
        className={`text-xs p-2 rounded ${focusMode ? 'bg-gray-700 text-gray-400' : 'bg-blue-50 text-blue-600'}`}
      >
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {showHint && (
            <Card
              className={focusMode ? 'bg-gray-700 border-gray-600' : 'bg-blue-50 border-blue-200'}
            >
              <CardContent className="p-3">
                <div
                  className={`text-xs space-y-2 ${focusMode ? 'text-gray-300' : 'text-blue-800'}`}
                >
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-200">
        <div className="flex items-center space-x-2">
          {answer !== undefined && answer !== '' && (
            <>
              ...
              <span className={`text-sm ${focusMode ? 'text-green-400' : 'text-green-600'}`}>
                已答题
              </span>
            </>
          )}
        ...
        <div className={`text-xs ${focusMode ? 'text-gray-400' : 'text-gray-500'}`}>
          💾 答案自动保存
        </div>
      </div>
    </div>
