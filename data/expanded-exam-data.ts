...
export const expandedAiBasicsQuestions: ExamQuestion[] = [
  ...
  // 强化学习专题
  {
    ...
    correctAnswer: 1,
    explanation:
      'Q-Learning的目标是学习最优的Q函数（状态-动作价值函数），通过不断更新Q值来找到最优策略。',
    points: 3,
    difficulty: 'hard',
    category: '强化学习',
  },
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      '数字孪生技术通过创建物理制造系统的虚拟副本，实现实时仿真、预测性维护、工艺优化等功能。',
    points: 3,
    difficulty: 'medium',
    category: '产业应用',
  },
...
export const expandedPromptQuestions: ExamQuestion[] = [
  ...
  },
  {
    ...
    type: 'essay',
    question:
      '为创意写作任务设计一个多步骤的Prompt工程流程，包括头脑风暴、大纲制作和内容生成三个阶段。',
    explanation:
...
export const expandedDevelopmentQuestions: ExamQuestion[] = [
  ...
  // 监控与运维
  {
    ...
    correctAnswer: 1,
    explanation:
      '模型监控最重要的是跟踪模型的准确率、精确率、召回率等性能指标，以及数据漂移、模型退化等问题。',
    points: 2,
    difficulty: 'easy',
    category: '模型监控',
  },
  ...
  },
  {
    ...
    correctAnswers: [0, 1, 2],
    explanation:
      '云原生AI平台包括容器运行时、服务网格、CI/CD流水线等组件。数据库是基础设施，不是云原生特有组件。',
    points: 3,
    difficulty: 'medium',
    category: '云原生',
  },
  ...
  // API设计与集成
  {
    ...
    correctAnswer: 1,
    explanation:
      'GET方法用于获取资源，POST用于创建，PUT用于更新，DELETE用于删除。这是RESTful API的标准约定。',
    points: 1,
    difficulty: 'easy',
    category: 'API设计',
  },
  ...
  // 成本优化
  {
    ...
    correctAnswer: 3,
    explanation:
      '成本优化策略包括按需扩缩容、预留实例、模型压缩等。盲目增加服务器数量会增加成本，不是优化策略。',
    points: 2,
    difficulty: 'easy',
    category: '成本优化',
  },
  ...
  // 行业应用案例
  {
    ...
    correctAnswer: 1,
    explanation:
      '边缘计算将计算能力部署在数据源附近，减少了数据传输延迟，提高了智慧城市应用的实时响应能力。',
    points: 2,
    difficulty: 'medium',
    category: '行业应用',
  },
...
export const expandedExams: Exam[] = [
  {
    ...
    title: 'AI基础知识测试',
    description:
      '全面测试您对人工智能各个领域的理解，包括机器学习、深度学习、计算机视觉、自然语言处理等',
    duration: 60,
    difficulty: '初级-中级',
    category: '基础理论',
