...
import { ModelAdapter, ModelConfig, ModelProvider, ModelRequest, ModelResponse } from './ModelAdapter';
  ...
  describe('initialize', () => {
    it('should initialize with valid configuration', async () => {
      const config = {
        ...
        routing: { type: 'smart' as const },
        loadBalancing: { strategy: 'round_robin' as const },
    ...
    it('should add a new model successfully', async () => {
      const config: ModelConfig = {
        ...
        capabilities: {
          ...
          supportedTaskTypes: ['chat', 'completion']
        }
      };
